...
class SingleDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        x = torch.FloatTensor(self.data.x[index].unsqueeze(0))
        y = torch.FloatTensor(self.data.y[index].unsqueeze(0))
